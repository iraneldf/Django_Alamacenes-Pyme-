...
(function(mod) {
  ...
  var Vim = function() {
    ...
    var vimApi= {
      ...
      // NOTE: This will not CRUD mappings to key maps that aren't present
          ...
          for (var i = userKeymap.length - 1; i >= 0; i--) {
            ...
            if (ctx !== mapping.context) {
              if (mapping.context) {
                ...
                // `mapping` applies to all contexts so CRUD keymap copies
    ...
    RegisterController.prototype = {
      ...
      // CRUD it.  If @name is invalid, return the unnamedRegister.
