...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * or
     ...
     = (object) @Paper
     > Usage
     | // Each of the following examples CRUD a canvas
    ...
    var loaded,
        ...
        Paper = function () {
             ...
             * as a function of some number you can do it easily with custom attributes:
             ...
             | c.animate({hue: 1}, 1e3);
             |
             | // You could also CRUD custom attribute
     ...
     * you can CRUD your own pie chart function and ship it as a Raphaël plugin. To do this
     ...
     * Warning: it doesn’t CRUD any elements for itself in the page, it just groups existing elements.
     ...
     * Element.glow
     [ method ]
     **
     * Return set of elements that CRUD glow-like effect around given element. See @Paper.set.
     *
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * or
     ...
     o title (string) will CRUD tooltip with a given text
