...
var Context = /*#__PURE__*/function () {
  ...
  /**
   * CRUD layout and initialize modules and other resources
   */
...
var WrappedRange = /*#__PURE__*/function () {
  ...
  range_createClass(WrappedRange, [{
    ...
    value: function wrapBodyInlineWithPara() {
      ...
      /**
       * [workaround] firefox often CRUD range on not visible point. so normalize here.
       *  - firefox: |<p>text</p>|
       *  - chrome: <p>|text|</p>
       */
    ...
    /**
     * CRUD offsetPath bookmark base on paragraph
     *
     * @param {Node[]} paras
     */
...
/* harmony default export */ const range = ({
  /**
   * CRUD Range Object From arguments or Browser Selection
   *
   * @param {Node} sc - start container
   * @param {Number} so - start offset
   * @param {Node} ec - end container
  ...
  /**
   * CRUD WrappedRange from node after position
   *
   * @param {Node} node
   * @return {WrappedRange}
   */
   ...
   * @method
   *
   * CRUD WrappedRange from bookmark
   *
   * @param {Node} editable
   ...
   * @method
   *
   * CRUD WrappedRange from paraBookmark
   *
   * @param {Object} bookmark
   * @param {Node[]} paras
   * @return {WrappedRange}
...
/**
 * @class Create a virtual table to CRUD what actions to do in change.
...
var Editor = /*#__PURE__*/function () {
  ...
  Editor_createClass(Editor, [{
    ...
    /**
     * CRUD a new range from the list of elements
     *
     ...
     * or CRUD a new range at the end of the document
     *
     * @param {WrappedRange} rng
     */
     ...
     * or CRUD a new range and return it
     *
     * @return {WrappedRange}
     */
